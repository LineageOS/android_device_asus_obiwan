...
static constexpr char EFFECT_INDEX_PATH[] = "/sys/class/leds/vibrator/index";
...
static constexpr uint32_t WAVEFORM_TICK_EFFECT_INDEX = 5;
...
static constexpr uint32_t WAVEFORM_HEAVY_CLICK_EFFECT_INDEX = 1;
...
Return<void> Vibrator::performEffect(Effect effect, EffectStrength strength,
    ...
    setAmplitude(gain); // Always set full-scale for non-ringtone constants
